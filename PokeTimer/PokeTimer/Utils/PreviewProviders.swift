...
struct PreviewData {
    ...
    static let sessionManager: SessionManager = {
        ...
        let session3 = Session(duration: 30 * 60, startTime: Date().addingTimeInterval(-7200), endTime: Date().addingTimeInterval(-6900), completed: true, pokemonID: pokemonManager.pokemons[2].id)
